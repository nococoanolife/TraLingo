const messages = {
  ja: {
    ...
    home_download_primary: 'GitHub Releases を開く',
    home_download_secondary: 'GitHub リポジトリを見る',
    ...
    docs_step_1_body:
      '設定画面の「モデルと接続」で OpenAI API キーを入力します。DeepL を使いたい場合だけ、DeepL キーも追加します。',
  ...
  en: {
    ...
    home_cta_secondary: 'Read the guide',
    ...
    home_download_primary: 'Open GitHub Releases',
    home_download_secondary: 'Open the repository',
    support_eyebrow: 'Support TraLingo',
    ...
    docs_step_1_body:
      'Open Settings and add your OpenAI API key first. Add a DeepL key only if you specifically want DeepL for translation.',
  ...
  ko: {
    ...
    home_download_primary: 'GitHub Releases 열기',
    home_download_secondary: 'GitHub 저장소 보기',
    support_eyebrow: 'Support TraLingo',
    ...
    docs_step_1_body:
      '설정에서 먼저 OpenAI API 키를 넣습니다. DeepL을 쓸 계획이 있을 때만 DeepL 키도 추가합니다.',
  ...
  zh: {
    ...
    home_download_primary: '打开 GitHub Releases',
    home_download_secondary: '查看 GitHub 仓库',
    support_eyebrow: 'Support TraLingo',
    ...
    docs_step_1_body:
      '先在设置里输入 OpenAI API 密钥。只有在打算使用 DeepL 时才需要再输入 DeepL 密钥。',
